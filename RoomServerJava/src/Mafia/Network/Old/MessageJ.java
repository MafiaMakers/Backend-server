...
public class MessageJ {
	...
	public MessageJ(int _id, int _partsCount, int _partIndex, int _type, ClientJ _client, char[] _data) {
		init();
		Setid(_id);
	...
	public native ClientJ Getclient();
	public native void Setclient(ClientJ data);
