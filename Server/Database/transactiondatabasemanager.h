...
namespace Mafia {
    namespace Database {
        ...
        private:
            /*!
             * \brief Функция, которая запускается автоматически и каждые несколько секунд проверяет, не изменена ли
             * какая-либо транзакция (свверяет хеши всех транзакций в БД)
             */
            void check_transaction_hashes();
