...
namespace Mafia {
    namespace System {
        ...
        public:
			 ...
			 * Суть функции очень проста: если это примитивный тип, то сериализуем его побитово.
			 * Если это список (или строка или массив), то сначала сериализуем его длину, а затем каждый элемент
			 * Если это структура или класс, то поочередно сериализуем все его поля
