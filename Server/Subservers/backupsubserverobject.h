...
namespace Mafia {
    namespace Subservers {
        ...
        public:
             ...
             */
            BackupSubserverObject(MainServerNetworker* networker, int port, const System::String path, const System::String processName,
        ...
        private slots:
             ...
             */
            void message_from_server(Message message) override;
